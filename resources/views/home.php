  ...
  <body class="hold-transition skin-green sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
         <li class="active"><a href="javascript:void(0);" onclick="cargarlistado(1,1);" > <span class="logo-lg"> </i> <l1>UTZIN </l1>  </a></li>
          </span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="javascript:void(0);" onclick="cargarlistado(1,1);" ><i class="fa fa-circle-o"></i>Usuarios</a></li>
