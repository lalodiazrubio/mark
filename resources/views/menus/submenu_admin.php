  <section> 
                     ...
                     <div id="capa_para_edicion" class="div_contenido" > 
                      ...
                      <div class="margin"  id="botones_control" >
                        ...
                        <button type="button" class="btn btn-success" onclick="mostrarseccion(3);" >Publicaciones</button>
                                  <button type="button" class="btn btn-success" onclick="mostrarseccion(1);" >Informacion</button>
